        ...
        col.innerHTML = `
          <div class="card h-100 card-jogo-hover border-0 shadow-sm rounded-4 overflow-hidden">
            <div class="position-relative">
              <img src="${jogador.imagem}" class="card-img-top img-fluid" alt="${jogador.nome}" 
            ...
            <div class="card-body px-3 pb-3 pt-2">
              ...
              <div class="d-flex justify-content-between align-items-center mb-3">
                ...
                <small class="text-muted d-flex align-items-center">
                  <i class="bi bi-flag me-1"></i> ${jogador.nacionalidade}
                </small>
              </div>
...
document.addEventListener('DOMContentLoaded', mostrarJogadores);